# -*- coding: utf-8 -*-
"""
Created on Thu May  6 14:12:25 2021
...
for f in df:
   ...
   #df=df[(((df['Op_Mod']=='0501') | (df['Op_Mod']=='0590') | (df['Op_Mod']=='0599') | (df['Op_Mod_2']=='01') |
          #(df['Op_Mod_2']=='02') | (df['Op_Mod_2']=='03') | (df['Op_Mod_2']=='04') | (df['Op_Mod_2']=='05') | (df['Op_Mod_2']=='06') |
          #(df['Op_Mod_2']=='07') | (df['Op_Mod_2']=='08') | (df['Op_Mod_2']=='09') | (df['Op_Mod_2']=='10') | (df['Op_Mod_2']=='11'))
          #& ((df['Op_NatuOp']=='01') | 
          #(df['Op_NatuOp']=='02') | (df['Op_NatuOp']=='03') | (df['Op_NatuOp']=='04') | (df['Op_NatuOp']=='05'))) 
          #| (((df['Op_Mod']=='0501') | (df['Op_Mod']=='0590') | (df['Op_Mod']=='0599') | (df['Op_Mod_2']=='01') |
          #(df['Op_Mod_2']=='02') | (df['Op_Mod_2']=='03') | (df['Op_Mod_2']=='04') | (df['Op_Mod_2']=='05') | (df['Op_Mod_2']=='06') |
          #(df['Op_Mod_2']=='07') | (df['Op_Mod_2']=='08') | (df['Op_Mod_2']=='09') | (df['Op_Mod_2']=='10') | (df['Op_Mod_2']=='11')) & ((df['Op_NatuOp']=='11') |
          #(df['Op_NatuOp']=='12') | (df['Op_NatuOp']=='13') | (df['Op_NatuOp']=='14') | (df['Op_NatuOp']=='15')) & (df['Op_CaracEspecial']=='35'))] 
